...
import { registerUsersCleanupCommand } from './commands/users-cleanup';
import { registerUsersRemediateCommand } from './commands/users-remediate';
...
registerUsersCleanupCommand(program, getOpts);
registerUsersRemediateCommand(program, getOpts);
